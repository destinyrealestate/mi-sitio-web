...
window.DESTINY_BLOG = (function () {
  ...
  const ROWS = [
    ...
    ["El walkthrough: tu último momento de poder antes de firmar la entrega", "tco-a-las-llaves-entrega-preconstruccion", 2026, "14 ago 2026", 7, 14, 1],
    ...
    ["El crédito en preconstrucción: financias con la tasa del cierre, no con la de hoy", "credito-extranjero-miami-2026", 2026, "10 ago 2026", 7, 10, 1],
